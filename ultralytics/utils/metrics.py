...
##############------------------------------------------------WIOU损失---------------------------------
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=True, SIoU=False, EIoU=False, WIoU=False, Focal=False,
             alpha=1, gamma=0.5, scale=False, eps=1e-7):         ###----这一块是改损失函数，你需要哪个，就把哪个True就行,V8自带的是ciou
